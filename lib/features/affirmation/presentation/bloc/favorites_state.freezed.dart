...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>({TResult Function()?  initial,TResult Function()?  loading,TResult Function( List<Affirmation> favorites)?  loaded,TResult Function()?  error,required TResult orElse(),}) {final _that = this;
switch (_that) {
case FavoritesInitial() when initial != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>({required TResult Function()  initial,required TResult Function()  loading,required TResult Function( List<Affirmation> favorites)  loaded,required TResult Function()  error,}) {final _that = this;
switch (_that) {
case FavoritesInitial():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>({TResult? Function()?  initial,TResult? Function()?  loading,TResult? Function( List<Affirmation> favorites)?  loaded,TResult? Function()?  error,}) {final _that = this;
switch (_that) {
case FavoritesInitial() when initial != null:
return initial();case FavoritesLoading() when loading != null:
return loading();case FavoritesLoaded() when loaded != null:
...
class FavoritesLoaded implements FavoritesState {
  const FavoritesLoaded(final  List<Affirmation> favorites): _favorites = favorites;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is FavoritesError);
}
